...
# Same as getRecommendationsByUser except returns a predicted score
# for a given movie
def getScoreByUser(prefs,person,movie,similarity=sim_pearson):
  totals={}
  simSums={}
  for other in prefs:
    # don't compare me to myself
...
# Same as getRecommendationsByItems except returns a predicted score
# for a given movie
def getScoreByItems(prefs,itemMatch,user,movie):
  userRatings=prefs[user]
  scores={}
  totalSim={}
